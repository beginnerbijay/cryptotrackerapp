...
export default function Pagination({page,setPage}) {
  ...
  return (
    <div className="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6 s:w-[100vw]">
      <div className="flex flex-1 justify-between sm:hidden sml:block sma:hidden">
        <a
          href="#"
      ...
      <div className="sm:flex sm:flex-1 sm:items-center sm:justify-between sml:hidden s:hidden">
        <div>
